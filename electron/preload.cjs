...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  addLocalEvent: (title, start, end, color) => ipcRenderer.invoke('add-local-event', title, start, end, color),
  updateLocalEvent: (id, start, end, title, color) => ipcRenderer.invoke('update-local-event', id, start, end, title, color),
  deleteLocalEvent: (id) => ipcRenderer.invoke('delete-local-event', id),
